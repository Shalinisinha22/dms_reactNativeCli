...
const OrderCard = ({isShowButton}:OrderCardProps) => {
    ...
    <Pressable
      ...
      <View style={styles.headerNoRowView}>
        <View style={styles.orderNoView}>
          ...
          <Text style={styles.orderNo}>{t('orderHistory.orderNo')} : 121124</Text>
          <Text style={styles.dispatchDate}>{t('orderHistory.dispatchDate')} : 16 Spt 2024</Text>
          </View>
        </View>
        {/* <Pressable
      ...
      <View style={styles.orderInfoRowView}>
        <View>
          <Text style={styles.orderinfoText}>{t('orderHistory.orderDate')}</Text>
          <Text style={styles.orderInfoDes}>12 Sept 2024</Text>
        </View>
        <View>
          <Text style={styles.orderinfoText}>{t('orderHistory.totalWeight')}</Text>
          <Text style={styles.orderInfoDes}>10 MT</Text>
        </View>
        <View>
          <Text style={styles.orderinfoText}>{t('orderHistory.totalAmount')}</Text>

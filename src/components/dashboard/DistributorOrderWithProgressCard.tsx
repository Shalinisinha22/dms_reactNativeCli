...
import {DistributorOrderWithProgressCardProps} from '../../interfaces/Types';
        ...
        <View>
          ...
          <View style={styles.orderInfoRowView}>
            ...
            <View>
              ...
              <Text style={styles.orderInfoDes}>12.30M</Text>
            </View>
            <View>
              <Text style={styles.orderinfoText}>
                {t('confirmOrder.amount')}
              </Text>
              <Text style={styles.orderInfoDes}>Rs.12000</Text>
            </View>
          </View>
        </View>
        <View>
